...
def add_dbt_struct():
    ...
    ida_struct.add_struc_member(sptr, "head", -1,
    ...
    ida_struct.add_struc_member(sptr, "line", -1,
                                idaapi.FF_DATA | idaapi.FF_DWORD, mt, 4)
    ida_struct.add_struc_member(sptr, "file", -1,
                                idaapi.FF_DWORD, mt, 4)
...
def add_mpu_region_struct():
    ...
    ida_struct.add_struc_member(sptr, "ap", -1, idaapi.FF_DATA |
                                idaapi.FF_DWORD, mt, 4)  # Data access permission
    ida_struct.add_struc_member(sptr, "xn", -1, idaapi.FF_DATA |
                                idaapi.FF_DWORD, mt, 4)  # Execute never
    ida_struct.add_struc_member(sptr, "se", -1, idaapi.FF_DATA |
                                idaapi.FF_DWORD, mt, 4)  # Shareable (S)
    ida_struct.add_struc_member(sptr, "ce", -1, idaapi.FF_DATA |
                                idaapi.FF_DWORD, mt, 4)  # Cacheable (C)
    ida_struct.add_struc_member(sptr, "be", -1, idaapi.FF_DATA |
                                idaapi.FF_DWORD, mt, 4)  # Bufferable (B)
    ida_struct.add_struc_member(sptr, "en", -1, idaapi.FF_DATA |
